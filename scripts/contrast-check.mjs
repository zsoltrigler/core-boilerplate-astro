...
const contrastPairs = [
  ...
  { name: "textInverted on brandPrimary (light)", fg: COLORS.textInverted, bg: COLORS.brandPrimary, min: 4.5 },
  ...
  { name: "textInverted on brandPrimary (dark)", fg: COLORS.textInverted, bg: COLORS.dark.brandPrimary, min: 4.5 },
